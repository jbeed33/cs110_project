    ...
    <>
      ...
      <div id="signup-container">
            <div id="signup-form">
                ...
                <form id="form" action="http://localhost:8080/api/user/" method="post">
                    <div className="form-content" >
                        <div className="signup-left">
                            ...
                            <input type="radio" name="options" value="in-person"></input><span className="box-text">In-Person</span><br/>
                            <input type="radio" name="options" value="remote"></input><span className="box-text">Remote</span><br/>
                            <input type="radio" name="options" value="both"></input><span className="box-text">Both</span><br/>
